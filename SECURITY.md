...
| Component | Version | Supported |
| --- | --- | --- |
| [Common Commit-changes](./actions/common/commit-changes) | actions-common-commit-changes-v1.0.0 | :white_check_mark: |
...
| Component | Version | Supported |
| --- | --- | --- |
| [Update Helm Chart Version](./actions/helm/update-chart-version) | actions-helm-update-chart-version-v1.3.2 | :white_check_mark: |
...
| Component | Version | Supported |
| --- | --- | --- |
| [Auto Format](./workflows/maintenance/auto-bun-prettier) | workflows-maintenance-auto-bun-prettier-v1.1.3 | :white_check_mark: |
