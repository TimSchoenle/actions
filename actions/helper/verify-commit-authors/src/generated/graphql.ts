...
export type VerifyCommitsQuery = { resource:
    ...
    | { __typename: 'PullRequest', commits: { totalCount: number, nodes: Array<{ commit: { oid: unknown, authors: { totalCount: number, nodes: Array<{ user: { databaseId: number | null } | null } | null> | null }, signature:
