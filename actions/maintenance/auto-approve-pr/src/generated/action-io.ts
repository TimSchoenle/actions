/**
 * Typed `@actions/core` accessors for the inputs and outputs declared in `actions/maintenance/auto-approve-pr/action.yaml`.
 *
...
export const ActionInput = {
  token: 'token',
  user_ids: 'user_ids',
  ignore_empty_prs: 'ignore_empty_prs',
  pr_url: 'pr_url',
...
export const ActionOutput = {} as const;
