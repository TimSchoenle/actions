/**
 * Typed `@actions/core` accessors for the inputs and outputs declared in `actions/maintenance/ensure-actions-are-executed/action.yaml`.
 *
...
export const ActionOutput = {
  matched_checks_count: 'matched_checks_count',
