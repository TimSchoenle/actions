...
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.2.19](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.2.19) | `uses: TimSchoenle/actions/actions/common/modify-yaml@actions-common-modify-yaml-v1.2.19 # tag=actions-common-modify-yaml-v1.2.19` |
