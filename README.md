...
| [Rust Cargo-check](./actions/rust/cargo-check) | Action that runs cargo check to verify Rust code compiles without errors. | [actions-rust-cargo-check-v1.1.2](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-cargo-check-v1.1.2) | `uses: TimSchoenle/actions/actions/rust/cargo-check@actions-rust-cargo-check-v1.1.2 # tag=actions-rust-cargo-check-v1.1.2` |
| [Rust Clippy](./actions/rust/clippy) | Action that runs clippy to catch common mistakes and improve your Rust code. | [actions-rust-clippy-v1.1.3](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-clippy-v1.1.3) | `uses: TimSchoenle/actions/actions/rust/clippy@afabf190e4b901c902ae684a4ca23375af8c444c # tag=actions-rust-clippy-v1.1.3` |
