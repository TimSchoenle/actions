...
| Workflow | Description | Version | Usage |
| --- | --- | --- | --- |
| [Rust Auto-format](./workflows/rust/auto-format) | Reusable workflow that runs cargo fmt and commits changes. | [workflows-rust-auto-format-v1.1.3](https://github.com/TimSchoenle/actions/releases/tag/workflows-rust-auto-format-v1.1.3) | `uses: TimSchoenle/actions/.github/workflows/rust-auto-format.yaml@workflows-rust-auto-format-v1.1.3` |
...
| [Rust Coverage (Codecov)](./workflows/rust/coverage-codecov) | Reusable workflow that runs cargo llvm-cov to generate code coverage and uploads to Codecov. | [workflows-rust-coverage-codecov-v1.0.5](https://github.com/TimSchoenle/actions/releases/tag/workflows-rust-coverage-codecov-v1.0.5) | `uses: TimSchoenle/actions/.github/workflows/rust-coverage-codecov.yaml@workflows-rust-coverage-codecov-v1.0.5` |
