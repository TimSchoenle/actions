...
| [Create Branch](./actions/common/create-branch) | Creates or resets a git branch using GitHub API. | [actions-common-create-branch-v1.4.3](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-branch-v1.4.3) | `uses: TimSchoenle/actions/actions/common/create-branch@09a7c8293914d24d1190c2903d405ac46bfaf454 # tag=actions-common-create-branch-v1.4.3` |
