...
| [Common Readme Variables](./actions/common/readme-variables) | Collect the standard README render payload — repository facts, release, toolchain and a docs index — as strict JSON for render-template | [actions-common-readme-variables-v1.0.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-readme-variables-v1.0.0) | `uses: TimSchoenle/actions/actions/common/readme-variables@actions-common-readme-variables-v1.0.0 # tag=actions-common-readme-variables-v1.0.0` |
