...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Close Pull Request](./actions/common/close-pull-request) | Closes a pull request | [actions-common-close-pull-request-v1.4.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-close-pull-request-v1.4.0) | `uses: TimSchoenle/actions/actions/common/close-pull-request@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-common-close-pull-request-v1.4.0` |
| [Commit Changes](./actions/common/commit-changes) | Commits changes using the GitHub API to ensure verified bot commits. | [actions-common-commit-changes-v1.4.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-commit-changes-v1.4.0) | `uses: TimSchoenle/actions/actions/common/commit-changes@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-common-commit-changes-v1.4.0` |
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.4.4](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.4.4) | `uses: TimSchoenle/actions/actions/common/modify-yaml@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-common-modify-yaml-v1.4.4` |
| [Common Read YAML](./actions/common/read-yaml) | A action to read a value from a YAML file using dot notation | [actions-common-read-yaml-v1.2.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-read-yaml-v1.2.2) | `uses: TimSchoenle/actions/actions/common/read-yaml@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-common-read-yaml-v1.2.2` |
| [Common Readme Variables](./actions/common/readme-variables) | Collect the standard README render payload — repository facts, release, toolchain and a docs index — as strict JSON for render-template | [actions-common-readme-variables-v1.1.1](https://github.com/TimSchoenle/actions/releases/tag/actions-common-readme-variables-v1.1.1) | `uses: TimSchoenle/actions/actions/common/readme-variables@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-common-readme-variables-v1.1.1` |
...
| [Create Pull Request](./actions/common/create-pull-request) | Creates or updates a pull request using GitHub App authentication with optional branch reset. | [actions-common-create-pull-request-v1.0.13](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-pull-request-v1.0.13) | `uses: TimSchoenle/actions/actions/common/create-pull-request@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-common-create-pull-request-v1.0.13` |
| [Delete-Branch](./actions/common/delete-branch) | Deletes a branch from a repository. Fails gracefully if the branch does not exist. | [actions-common-delete-branch-v1.4.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-delete-branch-v1.4.0) | `uses: TimSchoenle/actions/actions/common/delete-branch@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-common-delete-branch-v1.4.0` |
| [Get App Git Identity](./actions/common/get-app-git-identity) | Resolves the git identity (username, email, user ID) for a GitHub App bot. | [actions-common-get-app-git-identity-v1.4.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-get-app-git-identity-v1.4.0) | `uses: TimSchoenle/actions/actions/common/get-app-git-identity@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-common-get-app-git-identity-v1.4.0` |
...
| [Setup App Git Identity](./actions/common/setup-app-git-identity) | Configures git with the identity of a GitHub App bot and outputs the bot details. | [actions-common-setup-app-git-identity-v1.4.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-setup-app-git-identity-v1.4.0) | `uses: TimSchoenle/actions/actions/common/setup-app-git-identity@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-common-setup-app-git-identity-v1.4.0` |

#### Helm

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Apply Helm Chart Updates](./actions/helm/apply-chart-updates) | Applies a set of templated image updates to a Helm chart's values.yaml and bumps Chart.yaml, preserving comments and structure. Every image carries its own version and digest. | [actions-helm-apply-chart-updates-v1.2.2](https://github.com/TimSchoenle/actions/releases/tag/actions-helm-apply-chart-updates-v1.2.2) | `uses: TimSchoenle/actions/actions/helm/apply-chart-updates@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-helm-apply-chart-updates-v1.2.2` |
...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Helper Verify-branch-name](./actions/helper/verify-branch-name) | Verify the head branch of a pull request matches a pattern and check whether it comes from a fork | [actions-helper-verify-branch-name-v1.3.3](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-branch-name-v1.3.3) | `uses: TimSchoenle/actions/actions/helper/verify-branch-name@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-helper-verify-branch-name-v1.3.3` |
| [Resolve Branch](./actions/helper/resolve-base-branch) | Resolve the given base branch or return default branch. With optional existence check. | [actions-helper-resolve-base-branch-v1.4.0](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-resolve-base-branch-v1.4.0) | `uses: TimSchoenle/actions/actions/helper/resolve-base-branch@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-helper-resolve-base-branch-v1.4.0` |
| [Verify Commit Authors](./actions/helper/verify-commit-authors) | Verifies that all commits in a PR are authored by a specific set of users and are signed. | [actions-helper-verify-commit-authors-v1.4.0](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-commit-authors-v1.4.0) | `uses: TimSchoenle/actions/actions/helper/verify-commit-authors@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-helper-verify-commit-authors-v1.4.0` |

#### Java-gradle

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Java-gradle Auto-spotless](./actions/java-gradle/auto-spotless) | Automatically apply spotless formatting and commit changes. | [actions-java-gradle-auto-spotless-v1.1.17](https://github.com/TimSchoenle/actions/releases/tag/actions-java-gradle-auto-spotless-v1.1.17) | `uses: TimSchoenle/actions/actions/java-gradle/auto-spotless@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-java-gradle-auto-spotless-v1.1.17` |
| [Java-Gradle default setup](./actions/java-gradle/setup-base-environment) | Setup Java and Gradle environment for building, with opinionated default settings | [actions-java-gradle-setup-base-environment-v1.2.10](https://github.com/TimSchoenle/actions/releases/tag/actions-java-gradle-setup-base-environment-v1.2.10) | `uses: TimSchoenle/actions/actions/java-gradle/setup-base-environment@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-java-gradle-setup-base-environment-v1.2.10` |

#### Maintenance

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Maintenance Auto-approve-pr](./actions/maintenance/auto-approve-pr) | Auto approve Pull Requests with the given user ids and branches. | [actions-maintenance-auto-approve-pr-v1.4.0](https://github.com/TimSchoenle/actions/releases/tag/actions-maintenance-auto-approve-pr-v1.4.0) | `uses: TimSchoenle/actions/actions/maintenance/auto-approve-pr@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-maintenance-auto-approve-pr-v1.4.0` |
...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Rust Auto-format](./actions/rust/auto-format) | Action that runs cargo fmt and commits changes. | [actions-rust-auto-format-v1.1.12](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-auto-format-v1.1.12) | `uses: TimSchoenle/actions/actions/rust/auto-format@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-rust-auto-format-v1.1.12` |
...
| [Rust Config Contract](./actions/rust/config-contract) | Action that checks a terrace-config contract, its Dockerfile LABEL block and a built image against the configuration types they claim to describe. | [actions-rust-config-contract-v1.2.0](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-config-contract-v1.2.0) | `uses: TimSchoenle/actions/actions/rust/config-contract@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-rust-config-contract-v1.2.0` |
| [Rust Coverage (Codecov)](./actions/rust/coverage-codecov) | Action that runs cargo llvm-cov to generate code coverage and uploads to Codecov. | [actions-rust-coverage-codecov-v1.1.41](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-coverage-codecov-v1.1.41) | `uses: TimSchoenle/actions/actions/rust/coverage-codecov@e16a1e466faf8ec751b26289c1898143a253269f # tag=actions-rust-coverage-codecov-v1.1.41` |
