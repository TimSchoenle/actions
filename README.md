...
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.2.17](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.2.17) | `uses: TimSchoenle/actions/actions/common/modify-yaml@f5a2ffaadd4c291096c5b7e368fda3ab25bf950e # tag=actions-common-modify-yaml-v1.2.17` |
...
| [Create Pull Request](./actions/common/create-pull-request) | Creates or updates a pull request using GitHub App authentication with optional branch reset. | [actions-common-create-pull-request-v1.0.6](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-pull-request-v1.0.6) | `uses: TimSchoenle/actions/actions/common/create-pull-request@6ac9d25fec5594b05b51bd2eebafe606a6f5c917 # tag=actions-common-create-pull-request-v1.0.6` |
...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Update Helm Chart Version](./actions/helm/update-chart-version) | Updates a Helm chart version, appVersion, and image tag, then creates a Pull Request. This action requires a bot account with access to the charts repo. Requires structure: Chart.yaml (version, appVersion) and values.yaml (image.tag). | [actions-helm-update-chart-version-v1.5.11](https://github.com/TimSchoenle/actions/releases/tag/actions-helm-update-chart-version-v1.5.11) | `uses: TimSchoenle/actions/actions/helm/update-chart-version@actions-helm-update-chart-version-v1.5.11 # tag=actions-helm-update-chart-version-v1.5.11` |
...
| [Verify Commit Authors](./actions/helper/verify-commit-authors) | Verifies that all commits in a PR are authored by a specific set of users and are signed. | [actions-helper-verify-commit-authors-v1.1.20](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-commit-authors-v1.1.20) | `uses: TimSchoenle/actions/actions/helper/verify-commit-authors@52baef1f019b95979412945577f8367940bf192c # tag=actions-helper-verify-commit-authors-v1.1.20` |
...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Rust Auto-format](./actions/rust/auto-format) | Action that runs cargo fmt and commits changes. | [actions-rust-auto-format-v1.1.2](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-auto-format-v1.1.2) | `uses: TimSchoenle/actions/actions/rust/auto-format@d106bd05a6c8316530da2113f13b63f462c5c952 # tag=actions-rust-auto-format-v1.1.2` |
| [Rust Cargo-check](./actions/rust/cargo-check) | Action that runs cargo check to verify Rust code compiles without errors. | [actions-rust-cargo-check-v1.1.2](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-cargo-check-v1.1.2) | `uses: TimSchoenle/actions/actions/rust/cargo-check@0a7183bdc2cc4a098b6e9e2510cde4703c468a6c # tag=actions-rust-cargo-check-v1.1.2` |
| [Rust Clippy](./actions/rust/clippy) | Action that runs clippy to catch common mistakes and improve your Rust code. | [actions-rust-clippy-v1.1.4](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-clippy-v1.1.4) | `uses: TimSchoenle/actions/actions/rust/clippy@282fb785847f5aaa8f5052f924d03dc26e6a7d1c # tag=actions-rust-clippy-v1.1.4` |
| [Rust Coverage (Codecov)](./actions/rust/coverage-codecov) | Action that runs cargo llvm-cov to generate code coverage and uploads to Codecov. | [actions-rust-coverage-codecov-v1.1.16](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-coverage-codecov-v1.1.16) | `uses: TimSchoenle/actions/actions/rust/coverage-codecov@7d0037fcfb1657ed53dae12d9276d3a29ea27432 # tag=actions-rust-coverage-codecov-v1.1.16` |
...
| --- | --- | --- | --- |
| [Auto Format](./workflows/maintenance/auto-bun-prettier) | Reusable workflow to auto-format code using Bun (Prettier) and commit changes. | [workflows-maintenance-auto-bun-prettier-v1.1.15](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-auto-bun-prettier-v1.1.15) | `uses: TimSchoenle/actions/.github/workflows/maintenance-auto-bun-prettier.yaml@4fcbe90cb9a45a2c59f21bbdbba976c3a64b5e55 # tag=workflows-maintenance-auto-bun-prettier-v1.1.15` |
| [Auto-Approve & Merge Timed PRs](./workflows/maintenance/timed-auto-pr-approve) | Reusable workflow that automatically verifies, approves, and merges Pull Requests that match a specific branch pattern and have been open for a configurable duration. It ensures all commits are signed and authored by trusted users. | [workflows-maintenance-timed-auto-pr-approve-v1.2.19](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-timed-auto-pr-approve-v1.2.19) | `uses: TimSchoenle/actions/.github/workflows/maintenance-timed-auto-pr-approve.yaml@39cfe9bbdaed33882bdb42a2a7b76c342f03fdbd # tag=workflows-maintenance-timed-auto-pr-approve-v1.2.19` |
| [Maintenance Auto-approve-renovate](./workflows/maintenance/auto-approve-renovate) | Reusable workflow to auto approve Renovate PRs, this is useful to auto merge Renovate PRs which have auto-merge enabled. | [workflows-maintenance-auto-approve-renovate-v1.4.7](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-auto-approve-renovate-v1.4.7) | `uses: TimSchoenle/actions/.github/workflows/maintenance-auto-approve-renovate.yaml@2281355cc3c0ec31f63f616be0c40bbc2d4a5bdc # tag=workflows-maintenance-auto-approve-renovate-v1.4.7` |
| [Maintenance Auto-rebase](./workflows/maintenance/auto-rebase) | Automatically rebases open PRs with a given label. | [workflows-maintenance-auto-rebase-v1.1.5](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-auto-rebase-v1.1.5) | `uses: TimSchoenle/actions/.github/workflows/maintenance-auto-rebase.yaml@ad6fe4e4b895e7e3679d1be69e3f5374283c8cb2 # tag=workflows-maintenance-auto-rebase-v1.1.5` |
| [Maintenance Wipe-cache](./workflows/maintenance/wipe-cache) | Workflow to wipe all cache entries for the given branch. | [workflows-maintenance-wipe-cache-v1.1.8](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-wipe-cache-v1.1.8) | `uses: TimSchoenle/actions/.github/workflows/maintenance-wipe-cache.yaml@808c4e942433c5f18a4cf51550b1d3e8b2ab7da9 # tag=workflows-maintenance-wipe-cache-v1.1.8` |
