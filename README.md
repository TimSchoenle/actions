...
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.4.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.4.2) | `uses: TimSchoenle/actions/actions/common/modify-yaml@155a2973625b850478dbac5c2ced3d59d75de869 # tag=actions-common-modify-yaml-v1.4.2` |
