...
| --- | --- | --- | --- |
| [Bun Setup-cached](./actions/bun/setup-cached) | Sets up Bun and manages dependency caching. | [actions-bun-setup-cached-v1.1.9](https://github.com/TimSchoenle/actions/releases/tag/actions-bun-setup-cached-v1.1.9) | `uses: TimSchoenle/actions/actions/bun/setup-cached@0aa0c147fe0b45838bfe09b60463b374e96d6f2a # tag=actions-bun-setup-cached-v1.1.9` |
...
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.2.23](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.2.23) | `uses: TimSchoenle/actions/actions/common/modify-yaml@798511e42ad22a0ba66aabd6bcdd36f7afc3090a # tag=actions-common-modify-yaml-v1.2.23` |
...
| [Rust Cargo-check](./actions/rust/cargo-check) | Action that runs cargo check to verify Rust code compiles without errors. | [actions-rust-cargo-check-v1.1.4](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-cargo-check-v1.1.4) | `uses: TimSchoenle/actions/actions/rust/cargo-check@actions-rust-cargo-check-v1.1.4 # tag=actions-rust-cargo-check-v1.1.4` |
| [Rust Clippy](./actions/rust/clippy) | Action that runs clippy to catch common mistakes and improve your Rust code. | [actions-rust-clippy-v1.1.6](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-clippy-v1.1.6) | `uses: TimSchoenle/actions/actions/rust/clippy@3b8f3644915a0687ff03682a238cf2685bde5992 # tag=actions-rust-clippy-v1.1.6` |
| [Rust Coverage (Codecov)](./actions/rust/coverage-codecov) | Action that runs cargo llvm-cov to generate code coverage and uploads to Codecov. | [actions-rust-coverage-codecov-v1.1.24](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-coverage-codecov-v1.1.24) | `uses: TimSchoenle/actions/actions/rust/coverage-codecov@1f1ff3b19d669c13c18f3853056b9dc7ba813d09 # tag=actions-rust-coverage-codecov-v1.1.24` |
...
| --- | --- | --- | --- |
| [Auto Format](./workflows/maintenance/auto-bun-prettier) | Reusable workflow to auto-format code using Bun (Prettier) and commit changes. | [workflows-maintenance-auto-bun-prettier-v1.1.19](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-auto-bun-prettier-v1.1.19) | `uses: TimSchoenle/actions/.github/workflows/maintenance-auto-bun-prettier.yaml@169c3b7d50775a6b56b06b0259292170240d9256 # tag=workflows-maintenance-auto-bun-prettier-v1.1.19` |
| [Auto-Approve & Merge Timed PRs](./workflows/maintenance/timed-auto-pr-approve) | Reusable workflow that automatically verifies, approves, and merges Pull Requests that match a specific branch pattern and have been open for a configurable duration. It ensures all commits are signed and authored by trusted users. | [workflows-maintenance-timed-auto-pr-approve-v1.2.23](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-timed-auto-pr-approve-v1.2.23) | `uses: TimSchoenle/actions/.github/workflows/maintenance-timed-auto-pr-approve.yaml@904014c4e0daf9212b9ca501890c55bf28d83e00 # tag=workflows-maintenance-timed-auto-pr-approve-v1.2.23` |
| [Maintenance Auto-approve-renovate](./workflows/maintenance/auto-approve-renovate) | Reusable workflow to auto approve Renovate PRs, this is useful to auto merge Renovate PRs which have auto-merge enabled. | [workflows-maintenance-auto-approve-renovate-v1.4.12](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-auto-approve-renovate-v1.4.12) | `uses: TimSchoenle/actions/.github/workflows/maintenance-auto-approve-renovate.yaml@3d72aff7f76b1c06c186e3e05407dd0cd7fe7914 # tag=workflows-maintenance-auto-approve-renovate-v1.4.12` |
