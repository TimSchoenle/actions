...
| [Rust Test](./workflows/rust/test) | Reusable workflow for rust-test | workflows-rust-test-v1.0.0 | `uses: TimSchoenle/actions/.github/workflows/rust-test.yaml@workflows-rust-test-v1.0.0` |
