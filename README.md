...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Close Pull Request](./actions/common/close-pull-request) | Closes a pull request | [actions-common-close-pull-request-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-close-pull-request-v1.5.2) | `uses: TimSchoenle/actions/actions/common/close-pull-request@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-close-pull-request-v1.5.2` |
| [Commit Changes](./actions/common/commit-changes) | Commits changes using the GitHub API to ensure verified bot commits. | [actions-common-commit-changes-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-commit-changes-v1.5.2) | `uses: TimSchoenle/actions/actions/common/commit-changes@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-commit-changes-v1.5.2` |
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.5.2) | `uses: TimSchoenle/actions/actions/common/modify-yaml@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-modify-yaml-v1.5.2` |
| [Common Read YAML](./actions/common/read-yaml) | A action to read a value from a YAML file using dot notation | [actions-common-read-yaml-v1.3.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-read-yaml-v1.3.2) | `uses: TimSchoenle/actions/actions/common/read-yaml@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-read-yaml-v1.3.2` |
| [Common Readme Variables](./actions/common/readme-variables) | Collect the standard README render payload — repository facts, release, toolchain and a docs index — as strict JSON for render-template | [actions-common-readme-variables-v1.2.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-readme-variables-v1.2.2) | `uses: TimSchoenle/actions/actions/common/readme-variables@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-readme-variables-v1.2.2` |
| [Create Branch](./actions/common/create-branch) | Creates or resets a git branch using GitHub API. | [actions-common-create-branch-v1.6.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-branch-v1.6.2) | `uses: TimSchoenle/actions/actions/common/create-branch@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-create-branch-v1.6.2` |
| [Create Pull Request](./actions/common/create-pull-request) | Creates or updates a pull request using GitHub App authentication with optional branch reset. | [actions-common-create-pull-request-v1.0.19](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-pull-request-v1.0.19) | `uses: TimSchoenle/actions/actions/common/create-pull-request@actions-common-create-pull-request-v1.0.19 # tag=actions-common-create-pull-request-v1.0.19` |
| [Delete-Branch](./actions/common/delete-branch) | Deletes a branch from a repository. Fails gracefully if the branch does not exist. | [actions-common-delete-branch-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-delete-branch-v1.5.2) | `uses: TimSchoenle/actions/actions/common/delete-branch@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-delete-branch-v1.5.2` |
| [Get App Git Identity](./actions/common/get-app-git-identity) | Resolves the git identity (username, email, user ID) for a GitHub App bot. | [actions-common-get-app-git-identity-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-get-app-git-identity-v1.5.2) | `uses: TimSchoenle/actions/actions/common/get-app-git-identity@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-get-app-git-identity-v1.5.2` |
| [Render Template](./actions/common/render-template) | A action to render a Handlebars template file to an output file from a JSON map of variables, deterministically | [actions-common-render-template-v1.2.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-render-template-v1.2.2) | `uses: TimSchoenle/actions/actions/common/render-template@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-render-template-v1.2.2` |
| [Render Template And Commit](./actions/common/render-template-and-commit) | Renders a Handlebars template to a file and commits the result as a verified bot commit, skipping the commit when the render changed nothing. | [actions-common-render-template-and-commit-v1.1.10](https://github.com/TimSchoenle/actions/releases/tag/actions-common-render-template-and-commit-v1.1.10) | `uses: TimSchoenle/actions/actions/common/render-template-and-commit@actions-common-render-template-and-commit-v1.1.10 # tag=actions-common-render-template-and-commit-v1.1.10` |
| [Setup App Git Identity](./actions/common/setup-app-git-identity) | Configures git with the identity of a GitHub App bot and outputs the bot details. | [actions-common-setup-app-git-identity-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-setup-app-git-identity-v1.5.2) | `uses: TimSchoenle/actions/actions/common/setup-app-git-identity@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-setup-app-git-identity-v1.5.2` |
| [Upsert Issue](./actions/common/upsert-issue) | Opens or updates a repository issue, updating the previous issue carrying the same identifier. | [actions-common-upsert-issue-v1.1.1](https://github.com/TimSchoenle/actions/releases/tag/actions-common-upsert-issue-v1.1.1) | `uses: TimSchoenle/actions/actions/common/upsert-issue@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-upsert-issue-v1.1.1` |
| [Upsert PR Comment](./actions/common/upsert-pr-comment) | Posts a comment on a pull request, updating the previous comment carrying the same identifier. | [actions-common-upsert-pr-comment-v1.1.2](https://github.com/TimSchoenle/actions/releases/tag/actions-common-upsert-pr-comment-v1.1.2) | `uses: TimSchoenle/actions/actions/common/upsert-pr-comment@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-common-upsert-pr-comment-v1.1.2` |

#### Helm

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Apply Helm Chart Updates](./actions/helm/apply-chart-updates) | Applies a set of templated image updates to a Helm chart's values.yaml and bumps Chart.yaml, preserving comments and structure. Every image carries its own version and digest. | [actions-helm-apply-chart-updates-v1.3.2](https://github.com/TimSchoenle/actions/releases/tag/actions-helm-apply-chart-updates-v1.3.2) | `uses: TimSchoenle/actions/actions/helm/apply-chart-updates@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-helm-apply-chart-updates-v1.3.2` |
| [Update Helm Chart Version](./actions/helm/update-chart-version) | Updates a Helm chart's image tags, version and appVersion, then opens a Pull Request. Every image carries its own version and digest, so one call can move a chart with many services. This action requires a bot account with access to the charts repo. | [actions-helm-update-chart-version-v1.6.12](https://github.com/TimSchoenle/actions/releases/tag/actions-helm-update-chart-version-v1.6.12) | `uses: TimSchoenle/actions/actions/helm/update-chart-version@actions-helm-update-chart-version-v1.6.12 # tag=actions-helm-update-chart-version-v1.6.12` |

#### Helper

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Helper Verify-branch-name](./actions/helper/verify-branch-name) | Verify the head branch of a pull request matches a pattern and check whether it comes from a fork | [actions-helper-verify-branch-name-v1.4.2](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-branch-name-v1.4.2) | `uses: TimSchoenle/actions/actions/helper/verify-branch-name@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-helper-verify-branch-name-v1.4.2` |
| [Resolve Branch](./actions/helper/resolve-base-branch) | Resolve the given base branch or return default branch. With optional existence check. | [actions-helper-resolve-base-branch-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-resolve-base-branch-v1.5.2) | `uses: TimSchoenle/actions/actions/helper/resolve-base-branch@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-helper-resolve-base-branch-v1.5.2` |
| [Verify Commit Authors](./actions/helper/verify-commit-authors) | Verifies that all commits in a PR are authored by a specific set of users and are signed. | [actions-helper-verify-commit-authors-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-commit-authors-v1.5.2) | `uses: TimSchoenle/actions/actions/helper/verify-commit-authors@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-helper-verify-commit-authors-v1.5.2` |

#### Java-gradle

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Java-gradle Auto-spotless](./actions/java-gradle/auto-spotless) | Automatically apply spotless formatting and commit changes. | [actions-java-gradle-auto-spotless-v1.1.25](https://github.com/TimSchoenle/actions/releases/tag/actions-java-gradle-auto-spotless-v1.1.25) | `uses: TimSchoenle/actions/actions/java-gradle/auto-spotless@actions-java-gradle-auto-spotless-v1.1.25 # tag=actions-java-gradle-auto-spotless-v1.1.25` |
| [Java-Gradle default setup](./actions/java-gradle/setup-base-environment) | Setup Java and Gradle environment for building, with opinionated default settings | [actions-java-gradle-setup-base-environment-v1.2.12](https://github.com/TimSchoenle/actions/releases/tag/actions-java-gradle-setup-base-environment-v1.2.12) | `uses: TimSchoenle/actions/actions/java-gradle/setup-base-environment@88e964d440835fd99f7e9d17b4ba1b48544303ba # tag=actions-java-gradle-setup-base-environment-v1.2.12` |

#### Maintenance

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Maintenance Auto-approve-pr](./actions/maintenance/auto-approve-pr) | Auto approve Pull Requests with the given user ids and branches. | [actions-maintenance-auto-approve-pr-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-maintenance-auto-approve-pr-v1.5.2) | `uses: TimSchoenle/actions/actions/maintenance/auto-approve-pr@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-maintenance-auto-approve-pr-v1.5.2` |
| [Maintenance Ensure-actions-are-executed](./actions/maintenance/ensure-actions-are-executed) | Ensures selected checks completed successfully when they were started. | [actions-maintenance-ensure-actions-are-executed-v1.5.2](https://github.com/TimSchoenle/actions/releases/tag/actions-maintenance-ensure-actions-are-executed-v1.5.2) | `uses: TimSchoenle/actions/actions/maintenance/ensure-actions-are-executed@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-maintenance-ensure-actions-are-executed-v1.5.2` |

#### Rust

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Rust Auto-format](./actions/rust/auto-format) | Action that runs cargo fmt and commits changes. | [actions-rust-auto-format-v1.1.18](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-auto-format-v1.1.18) | `uses: TimSchoenle/actions/actions/rust/auto-format@actions-rust-auto-format-v1.1.18 # tag=actions-rust-auto-format-v1.1.18` |
| [Rust Cargo-check](./actions/rust/cargo-check) | Action that runs cargo check to verify Rust code compiles without errors. | [actions-rust-cargo-check-v1.1.7](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-cargo-check-v1.1.7) | `uses: TimSchoenle/actions/actions/rust/cargo-check@88e964d440835fd99f7e9d17b4ba1b48544303ba # tag=actions-rust-cargo-check-v1.1.7` |
| [Rust Clippy](./actions/rust/clippy) | Action that runs clippy to catch common mistakes and improve your Rust code. | [actions-rust-clippy-v1.1.11](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-clippy-v1.1.11) | `uses: TimSchoenle/actions/actions/rust/clippy@88e964d440835fd99f7e9d17b4ba1b48544303ba # tag=actions-rust-clippy-v1.1.11` |
| [Rust Config Contract](./actions/rust/config-contract) | Action that checks a terrace-config contract, its Dockerfile LABEL block and a built image against the configuration types they claim to describe. | [actions-rust-config-contract-v1.3.2](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-config-contract-v1.3.2) | `uses: TimSchoenle/actions/actions/rust/config-contract@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-rust-config-contract-v1.3.2` |
| [Rust Coverage (Codecov)](./actions/rust/coverage-codecov) | Action that runs cargo llvm-cov to generate code coverage and uploads to Codecov. | [actions-rust-coverage-codecov-v1.1.48](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-coverage-codecov-v1.1.48) | `uses: TimSchoenle/actions/actions/rust/coverage-codecov@5edf216e14f1ba5cb4b5444c1bd67b87139a12ac # tag=actions-rust-coverage-codecov-v1.1.48` |
...
Vendor `configs/checkstyle/application/` and `configs/checkstyle/_shared/` into your project, then point your build tool's config directory (Gradle `configDirectory`, Maven `config_loc`) at your copy of `configs/checkstyle/application/`. Or depend on it directly via [JitPack](https://jitpack.io), no vendoring or config directory required:
...
Vendor `configs/checkstyle/library/` and `configs/checkstyle/_shared/` into your project, then point your build tool's config directory (Gradle `configDirectory`, Maven `config_loc`) at your copy of `configs/checkstyle/library/`. Or depend on it directly via [JitPack](https://jitpack.io), no vendoring or config directory required:
