...
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.2.14](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.2.14) | `uses: TimSchoenle/actions/actions/common/modify-yaml@11da954510cd3a71c17d3f23e472bbcaab734e0a # tag=actions-common-modify-yaml-v1.2.14` |
...
| [Verify Commit Authors](./actions/helper/verify-commit-authors) | Verifies that all commits in a PR are authored by a specific set of users and are signed. | [actions-helper-verify-commit-authors-v1.1.17](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-commit-authors-v1.1.17) | `uses: TimSchoenle/actions/actions/helper/verify-commit-authors@5fb953d804df0a46026bf2081e3bd79fb2abfb85 # tag=actions-helper-verify-commit-authors-v1.1.17` |
...
| [Rust Clippy](./actions/rust/clippy) | Action that runs clippy to catch common mistakes and improve your Rust code. | [actions-rust-clippy-v1.1.2](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-clippy-v1.1.2) | `uses: TimSchoenle/actions/actions/rust/clippy@c076d8181a6e23c7a274a7ca2019110dbf7b2e36 # tag=actions-rust-clippy-v1.1.2` |
| [Rust Coverage (Codecov)](./actions/rust/coverage-codecov) | Action that runs cargo llvm-cov to generate code coverage and uploads to Codecov. | [actions-rust-coverage-codecov-v1.1.9](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-coverage-codecov-v1.1.9) | `uses: TimSchoenle/actions/actions/rust/coverage-codecov@b66f0d6a20f0dcd984cc6b0a72030cab1f3b7d0c # tag=actions-rust-coverage-codecov-v1.1.9` |
...
| [Auto-Approve & Merge Timed PRs](./workflows/maintenance/timed-auto-pr-approve) | Reusable workflow that automatically verifies, approves, and merges Pull Requests that match a specific branch pattern and have been open for a configurable duration. It ensures all commits are signed and authored by trusted users. | [workflows-maintenance-timed-auto-pr-approve-v1.2.15](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-timed-auto-pr-approve-v1.2.15) | `uses: TimSchoenle/actions/.github/workflows/maintenance-timed-auto-pr-approve.yaml@21d0dc079f121395b18fd283304644debdda5b29 # tag=workflows-maintenance-timed-auto-pr-approve-v1.2.15` |
| [Maintenance Auto-approve-renovate](./workflows/maintenance/auto-approve-renovate) | Reusable workflow to auto approve Renovate PRs, this is useful to auto merge Renovate PRs which have auto-merge enabled. | [workflows-maintenance-auto-approve-renovate-v1.4.5](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-auto-approve-renovate-v1.4.5) | `uses: TimSchoenle/actions/.github/workflows/maintenance-auto-approve-renovate.yaml@ebe2694141617e28acc6d8aa88caa959b4604c3e # tag=workflows-maintenance-auto-approve-renovate-v1.4.5` |
