...
| [Resolve Branch](./actions/helper/resolve-base-branch) | Resolve the given base branch or return default branch. With optional existence check. | [actions-helper-resolve-base-branch-v1.3.3](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-resolve-base-branch-v1.3.3) | `uses: TimSchoenle/actions/actions/helper/resolve-base-branch@actions-helper-resolve-base-branch-v1.3.3 # tag=actions-helper-resolve-base-branch-v1.3.3` |
