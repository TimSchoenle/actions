...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Common Commit-changes](./actions/common/commit-changes) | A reusable action. | actions-common-commit-changes-v1.0.0 | `uses: TimSchoenle/actions/actions/common/commit-changes@actions-common-commit-changes-v1.0.0` |
