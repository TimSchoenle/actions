...
| [Common Delete-branch](./actions/common/delete-branch) | A reusable action. | actions-common-delete-branch-v1.0.0 | `uses: TimSchoenle/actions/actions/common/delete-branch@actions-common-delete-branch-v1.0.0` |
