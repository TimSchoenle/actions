...
| [Rust Clippy](./workflows/rust/clippy) | Reusable workflow that runs clippy to catch common mistakes and improve your Rust code. | [workflows-rust-clippy-v1.1.3](https://github.com/TimSchoenle/actions/releases/tag/workflows-rust-clippy-v1.1.3) | `uses: TimSchoenle/actions/.github/workflows/rust-clippy.yaml@workflows-rust-clippy-v1.1.3` |
