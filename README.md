...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Close Pull Request](./actions/common/close-pull-request) | Closes a pull request | [actions-common-close-pull-request-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-close-pull-request-v1.5.0) | `uses: TimSchoenle/actions/actions/common/close-pull-request@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-close-pull-request-v1.5.0` |
| [Commit Changes](./actions/common/commit-changes) | Commits changes using the GitHub API to ensure verified bot commits. | [actions-common-commit-changes-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-commit-changes-v1.5.0) | `uses: TimSchoenle/actions/actions/common/commit-changes@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-commit-changes-v1.5.0` |
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.5.0) | `uses: TimSchoenle/actions/actions/common/modify-yaml@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-modify-yaml-v1.5.0` |
| [Common Read YAML](./actions/common/read-yaml) | A action to read a value from a YAML file using dot notation | [actions-common-read-yaml-v1.3.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-read-yaml-v1.3.0) | `uses: TimSchoenle/actions/actions/common/read-yaml@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-read-yaml-v1.3.0` |
| [Common Readme Variables](./actions/common/readme-variables) | Collect the standard README render payload — repository facts, release, toolchain and a docs index — as strict JSON for render-template | [actions-common-readme-variables-v1.2.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-readme-variables-v1.2.0) | `uses: TimSchoenle/actions/actions/common/readme-variables@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-readme-variables-v1.2.0` |
| [Create Branch](./actions/common/create-branch) | Creates or resets a git branch using GitHub API. | [actions-common-create-branch-v1.6.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-branch-v1.6.0) | `uses: TimSchoenle/actions/actions/common/create-branch@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-create-branch-v1.6.0` |
| [Create Pull Request](./actions/common/create-pull-request) | Creates or updates a pull request using GitHub App authentication with optional branch reset. | [actions-common-create-pull-request-v1.0.15](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-pull-request-v1.0.15) | `uses: TimSchoenle/actions/actions/common/create-pull-request@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-create-pull-request-v1.0.15` |
| [Delete-Branch](./actions/common/delete-branch) | Deletes a branch from a repository. Fails gracefully if the branch does not exist. | [actions-common-delete-branch-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-delete-branch-v1.5.0) | `uses: TimSchoenle/actions/actions/common/delete-branch@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-delete-branch-v1.5.0` |
| [Get App Git Identity](./actions/common/get-app-git-identity) | Resolves the git identity (username, email, user ID) for a GitHub App bot. | [actions-common-get-app-git-identity-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-get-app-git-identity-v1.5.0) | `uses: TimSchoenle/actions/actions/common/get-app-git-identity@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-get-app-git-identity-v1.5.0` |
| [Render Template](./actions/common/render-template) | A action to render a Handlebars template file to an output file from a JSON map of variables, deterministically | [actions-common-render-template-v1.2.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-render-template-v1.2.0) | `uses: TimSchoenle/actions/actions/common/render-template@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-render-template-v1.2.0` |
| [Render Template And Commit](./actions/common/render-template-and-commit) | Renders a Handlebars template to a file and commits the result as a verified bot commit, skipping the commit when the render changed nothing. | [actions-common-render-template-and-commit-v1.1.6](https://github.com/TimSchoenle/actions/releases/tag/actions-common-render-template-and-commit-v1.1.6) | `uses: TimSchoenle/actions/actions/common/render-template-and-commit@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-render-template-and-commit-v1.1.6` |
| [Setup App Git Identity](./actions/common/setup-app-git-identity) | Configures git with the identity of a GitHub App bot and outputs the bot details. | [actions-common-setup-app-git-identity-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-setup-app-git-identity-v1.5.0) | `uses: TimSchoenle/actions/actions/common/setup-app-git-identity@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-setup-app-git-identity-v1.5.0` |
| [Upsert PR Comment](./actions/common/upsert-pr-comment) | Posts a comment on a pull request, updating the previous comment carrying the same identifier. | [actions-common-upsert-pr-comment-v1.1.0](https://github.com/TimSchoenle/actions/releases/tag/actions-common-upsert-pr-comment-v1.1.0) | `uses: TimSchoenle/actions/actions/common/upsert-pr-comment@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-common-upsert-pr-comment-v1.1.0` |

#### Helm

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Apply Helm Chart Updates](./actions/helm/apply-chart-updates) | Applies a set of templated image updates to a Helm chart's values.yaml and bumps Chart.yaml, preserving comments and structure. Every image carries its own version and digest. | [actions-helm-apply-chart-updates-v1.3.0](https://github.com/TimSchoenle/actions/releases/tag/actions-helm-apply-chart-updates-v1.3.0) | `uses: TimSchoenle/actions/actions/helm/apply-chart-updates@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-helm-apply-chart-updates-v1.3.0` |
| [Update Helm Chart Version](./actions/helm/update-chart-version) | Updates a Helm chart's image tags, version and appVersion, then opens a Pull Request. Every image carries its own version and digest, so one call can move a chart with many services. This action requires a bot account with access to the charts repo. | [actions-helm-update-chart-version-v1.6.7](https://github.com/TimSchoenle/actions/releases/tag/actions-helm-update-chart-version-v1.6.7) | `uses: TimSchoenle/actions/actions/helm/update-chart-version@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-helm-update-chart-version-v1.6.7` |

#### Helper

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Helper Verify-branch-name](./actions/helper/verify-branch-name) | Verify the head branch of a pull request matches a pattern and check whether it comes from a fork | [actions-helper-verify-branch-name-v1.4.0](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-branch-name-v1.4.0) | `uses: TimSchoenle/actions/actions/helper/verify-branch-name@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-helper-verify-branch-name-v1.4.0` |
| [Resolve Branch](./actions/helper/resolve-base-branch) | Resolve the given base branch or return default branch. With optional existence check. | [actions-helper-resolve-base-branch-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-resolve-base-branch-v1.5.0) | `uses: TimSchoenle/actions/actions/helper/resolve-base-branch@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-helper-resolve-base-branch-v1.5.0` |
| [Verify Commit Authors](./actions/helper/verify-commit-authors) | Verifies that all commits in a PR are authored by a specific set of users and are signed. | [actions-helper-verify-commit-authors-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-commit-authors-v1.5.0) | `uses: TimSchoenle/actions/actions/helper/verify-commit-authors@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-helper-verify-commit-authors-v1.5.0` |

#### Java-gradle

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Java-gradle Auto-spotless](./actions/java-gradle/auto-spotless) | Automatically apply spotless formatting and commit changes. | [actions-java-gradle-auto-spotless-v1.1.20](https://github.com/TimSchoenle/actions/releases/tag/actions-java-gradle-auto-spotless-v1.1.20) | `uses: TimSchoenle/actions/actions/java-gradle/auto-spotless@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-java-gradle-auto-spotless-v1.1.20` |
...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Maintenance Auto-approve-pr](./actions/maintenance/auto-approve-pr) | Auto approve Pull Requests with the given user ids and branches. | [actions-maintenance-auto-approve-pr-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-maintenance-auto-approve-pr-v1.5.0) | `uses: TimSchoenle/actions/actions/maintenance/auto-approve-pr@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-maintenance-auto-approve-pr-v1.5.0` |
| [Maintenance Ensure-actions-are-executed](./actions/maintenance/ensure-actions-are-executed) | Ensures selected checks completed successfully when they were started. | [actions-maintenance-ensure-actions-are-executed-v1.5.0](https://github.com/TimSchoenle/actions/releases/tag/actions-maintenance-ensure-actions-are-executed-v1.5.0) | `uses: TimSchoenle/actions/actions/maintenance/ensure-actions-are-executed@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-maintenance-ensure-actions-are-executed-v1.5.0` |

#### Rust

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Rust Auto-format](./actions/rust/auto-format) | Action that runs cargo fmt and commits changes. | [actions-rust-auto-format-v1.1.14](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-auto-format-v1.1.14) | `uses: TimSchoenle/actions/actions/rust/auto-format@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-rust-auto-format-v1.1.14` |
...
| [Rust Config Contract](./actions/rust/config-contract) | Action that checks a terrace-config contract, its Dockerfile LABEL block and a built image against the configuration types they claim to describe. | [actions-rust-config-contract-v1.3.0](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-config-contract-v1.3.0) | `uses: TimSchoenle/actions/actions/rust/config-contract@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-rust-config-contract-v1.3.0` |
| [Rust Coverage (Codecov)](./actions/rust/coverage-codecov) | Action that runs cargo llvm-cov to generate code coverage and uploads to Codecov. | [actions-rust-coverage-codecov-v1.1.44](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-coverage-codecov-v1.1.44) | `uses: TimSchoenle/actions/actions/rust/coverage-codecov@30bc73a560c7aac65f449b23378b9fd7782f8d39 # tag=actions-rust-coverage-codecov-v1.1.44` |
