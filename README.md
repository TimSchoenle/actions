...
| [Common Setup-app-git-identity](./actions/common/setup-app-git-identity) | A reusable action. | actions-common-setup-app-git-identity-v1.0.0 | `uses: TimSchoenle/actions/actions/common/setup-app-git-identity@actions-common-setup-app-git-identity-v1.0.0` |
