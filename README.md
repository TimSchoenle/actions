...
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.2.20](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.2.20) | `uses: TimSchoenle/actions/actions/common/modify-yaml@9888f57ee418055da0ac36e5e501f469d12a80cc # tag=actions-common-modify-yaml-v1.2.20` |
...
| [Verify Commit Authors](./actions/helper/verify-commit-authors) | Verifies that all commits in a PR are authored by a specific set of users and are signed. | [actions-helper-verify-commit-authors-v1.1.23](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-commit-authors-v1.1.23) | `uses: TimSchoenle/actions/actions/helper/verify-commit-authors@b8457c8b235b02ed9f3478b7e9946ee6216b7ce7 # tag=actions-helper-verify-commit-authors-v1.1.23` |

### Java-gradle

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Java-gradle Auto-spotless](./actions/java-gradle/auto-spotless) | Automatically apply spotless formatting and commit changes. | [actions-java-gradle-auto-spotless-v1.1.6](https://github.com/TimSchoenle/actions/releases/tag/actions-java-gradle-auto-spotless-v1.1.6) | `uses: TimSchoenle/actions/actions/java-gradle/auto-spotless@2da8a431711d10ff5da0d6bc50066030929339ef # tag=actions-java-gradle-auto-spotless-v1.1.6` |
| [Java-Gradle default setup](./actions/java-gradle/setup-base-environment) | Setup Java and Gradle environment for building, with opinionated default settings | [actions-java-gradle-setup-base-environment-v1.2.4](https://github.com/TimSchoenle/actions/releases/tag/actions-java-gradle-setup-base-environment-v1.2.4) | `uses: TimSchoenle/actions/actions/java-gradle/setup-base-environment@actions-java-gradle-setup-base-environment-v1.2.4 # tag=actions-java-gradle-setup-base-environment-v1.2.4` |

### Maintenance

| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Maintenance Auto-approve-pr](./actions/maintenance/auto-approve-pr) | Auto approve Pull Requests with the given user ids and branches. | [actions-maintenance-auto-approve-pr-v1.1.13](https://github.com/TimSchoenle/actions/releases/tag/actions-maintenance-auto-approve-pr-v1.1.13) | `uses: TimSchoenle/actions/actions/maintenance/auto-approve-pr@9c57f38a292b46432504a029aed8c6d93ba607cb # tag=actions-maintenance-auto-approve-pr-v1.1.13` |
...
| [Rust Coverage (Codecov)](./actions/rust/coverage-codecov) | Action that runs cargo llvm-cov to generate code coverage and uploads to Codecov. | [actions-rust-coverage-codecov-v1.1.20](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-coverage-codecov-v1.1.20) | `uses: TimSchoenle/actions/actions/rust/coverage-codecov@17421f2d8fb27b438d35a2cc2723780c1829afbd # tag=actions-rust-coverage-codecov-v1.1.20` |
