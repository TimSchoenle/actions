...
| [Create Branch](./actions/common/create-branch) | Creates or resets a git branch using GitHub API. | [actions-common-create-branch-v1.4.4](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-branch-v1.4.4) | `uses: TimSchoenle/actions/actions/common/create-branch@eebcc1d0a53fa82802187feae9a2eca9e6c175d5 # tag=actions-common-create-branch-v1.4.4` |
