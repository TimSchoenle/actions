...
| [Rust Config Contract](./actions/rust/config-contract) | Action that checks a terrace-config contract, its Dockerfile LABEL block and a built image against the configuration types they claim to describe. | [actions-rust-config-contract-v1.0.0](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-config-contract-v1.0.0) | `uses: TimSchoenle/actions/actions/rust/config-contract@actions-rust-config-contract-v1.0.0 # tag=actions-rust-config-contract-v1.0.0` |
