...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Close Pull Request](./actions/common/close-pull-request) | Closes a pull request | [actions-common-close-pull-request-v1.3.1](https://github.com/TimSchoenle/actions/releases/tag/actions-common-close-pull-request-v1.3.1) | `uses: TimSchoenle/actions/actions/common/close-pull-request@ca183a35122222b9e4b1764fae5095d92a91cf2e # tag=actions-common-close-pull-request-v1.3.1` |
| [Commit Changes](./actions/common/commit-changes) | Commits changes using the GitHub API to ensure verified bot commits. | [actions-common-commit-changes-v1.3.1](https://github.com/TimSchoenle/actions/releases/tag/actions-common-commit-changes-v1.3.1) | `uses: TimSchoenle/actions/actions/common/commit-changes@0a6ad3014d13b1baa2e6ab1966603fe88ed5887b # tag=actions-common-commit-changes-v1.3.1` |
...
| [Create Branch](./actions/common/create-branch) | Creates or resets a git branch using GitHub API. | [actions-common-create-branch-v1.4.1](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-branch-v1.4.1) | `uses: TimSchoenle/actions/actions/common/create-branch@a8b2bff1808af807bed9ae766d344163d0d4e480 # tag=actions-common-create-branch-v1.4.1` |
...
| [Delete-Branch](./actions/common/delete-branch) | Deletes a branch from a repository. Fails gracefully if the branch does not exist. | [actions-common-delete-branch-v1.3.1](https://github.com/TimSchoenle/actions/releases/tag/actions-common-delete-branch-v1.3.1) | `uses: TimSchoenle/actions/actions/common/delete-branch@ffb4ac89df04182fc06f77e88e1c52a557641f55 # tag=actions-common-delete-branch-v1.3.1` |
| [Get App Git Identity](./actions/common/get-app-git-identity) | Resolves the git identity (username, email, user ID) for a GitHub App bot. | [actions-common-get-app-git-identity-v1.3.1](https://github.com/TimSchoenle/actions/releases/tag/actions-common-get-app-git-identity-v1.3.1) | `uses: TimSchoenle/actions/actions/common/get-app-git-identity@c3be7a5a3f4d2957714d4b56018a169a1e65645a # tag=actions-common-get-app-git-identity-v1.3.1` |
...
| [Update Helm Chart Version](./actions/helm/update-chart-version) | Updates a Helm chart's image tags, version and appVersion, then opens a Pull Request. Every image carries its own version and digest, so one call can move a chart with many services. This action requires a bot account with access to the charts repo. | [actions-helm-update-chart-version-v1.6.1](https://github.com/TimSchoenle/actions/releases/tag/actions-helm-update-chart-version-v1.6.1) | `uses: TimSchoenle/actions/actions/helm/update-chart-version@9278d7738d3db8b90a9943709721455576558724 # tag=actions-helm-update-chart-version-v1.6.1` |
...
| [Resolve Branch](./actions/helper/resolve-base-branch) | Resolve the given base branch or return default branch. With optional existence check. | [actions-helper-resolve-base-branch-v1.3.1](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-resolve-base-branch-v1.3.1) | `uses: TimSchoenle/actions/actions/helper/resolve-base-branch@c208cd72bed82c601e214cd91d2941cf9891140c # tag=actions-helper-resolve-base-branch-v1.3.1` |
| [Verify Commit Authors](./actions/helper/verify-commit-authors) | Verifies that all commits in a PR are authored by a specific set of users and are signed. | [actions-helper-verify-commit-authors-v1.3.1](https://github.com/TimSchoenle/actions/releases/tag/actions-helper-verify-commit-authors-v1.3.1) | `uses: TimSchoenle/actions/actions/helper/verify-commit-authors@123c03a870474838ffa060250b113fbfb50a2ea0 # tag=actions-helper-verify-commit-authors-v1.3.1` |
...
| [Rust Coverage (Codecov)](./actions/rust/coverage-codecov) | Action that runs cargo llvm-cov to generate code coverage and uploads to Codecov. | [actions-rust-coverage-codecov-v1.1.37](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-coverage-codecov-v1.1.37) | `uses: TimSchoenle/actions/actions/rust/coverage-codecov@b234f52ef13ca0420e3a3e2c61d8af128a56d2dc # tag=actions-rust-coverage-codecov-v1.1.37` |
...
| --- | --- | --- | --- |
| [Auto Format](./workflows/maintenance/auto-bun-prettier) | Reusable workflow to auto-format code by running a "bun run" script and commit changes. | [workflows-maintenance-auto-bun-prettier-v1.1.26](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-auto-bun-prettier-v1.1.26) | `uses: TimSchoenle/actions/.github/workflows/maintenance-auto-bun-prettier.yaml@8ae06c28d11986fc44c1f1d8a1958ff42e09c63a # tag=workflows-maintenance-auto-bun-prettier-v1.1.26` |
| [Auto-Approve & Merge Timed PRs](./workflows/maintenance/timed-auto-pr-approve) | Reusable workflow that automatically verifies, approves, and merges Pull Requests that match a specific branch pattern and have been open for a configurable duration. It ensures all commits are signed and authored by trusted users. | [workflows-maintenance-timed-auto-pr-approve-v1.2.30](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-timed-auto-pr-approve-v1.2.30) | `uses: TimSchoenle/actions/.github/workflows/maintenance-timed-auto-pr-approve.yaml@2920da89dce8245f9c259efa8679f643817725f7 # tag=workflows-maintenance-timed-auto-pr-approve-v1.2.30` |
| [Maintenance Auto-approve-renovate](./workflows/maintenance/auto-approve-renovate) | Reusable workflow to auto approve Renovate PRs, this is useful to auto merge Renovate PRs which have auto-merge enabled. | [workflows-maintenance-auto-approve-renovate-v1.4.19](https://github.com/TimSchoenle/actions/releases/tag/workflows-maintenance-auto-approve-renovate-v1.4.19) | `uses: TimSchoenle/actions/.github/workflows/maintenance-auto-approve-renovate.yaml@4d47472ec2f03795b33634bdff2aad101beb429e # tag=workflows-maintenance-auto-approve-renovate-v1.4.19` |
