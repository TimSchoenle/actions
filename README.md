...
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | [actions-common-modify-yaml-v1.2.24](https://github.com/TimSchoenle/actions/releases/tag/actions-common-modify-yaml-v1.2.24) | `uses: TimSchoenle/actions/actions/common/modify-yaml@2d0ad38565dbbee27e4b9902f81576201f5585ba # tag=actions-common-modify-yaml-v1.2.24` |
