...
|--------|-------------|---------|-------|
| [Common Modify YAML](./actions/common/modify-yaml) | A action to modify a value in a YAML file while strictly preserving comments and structure | 273ebae | `uses: TimSchoenle/actions/actions/common/modify-yaml@273ebae` |
